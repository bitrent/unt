...
/**
* @dev Multisig Wallet with 3 predefined admins
*/
contract UNTBMultisigWallet {
  /*
   *  Events
   */
   ...
   */
  /**
    * @dev Max count of wallet owners including admins. Currently - 10
    */ 
  uint constant public MAX_OWNER_COUNT = 10;

  /**
    * @dev Cound of admin users. Currently - 3
    */ 
  uint constant public ADMINS_COUNT = 3;
  ...
  */
  ...
  function UNTBMultisigWallet(address[] _admins, uint _required)
  public
